...
with open("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/model/model-bw.json", "w") as json_file:
    json_file.write(model_json)
print('Model Saved')
classifier.save_weights('C:/Users/Harshit Gupta/Sign-Language-to-Text-master/model/model-bw.h5')
print('Weights saved')
