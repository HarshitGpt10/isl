...
if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data"):
    os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data")
if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/train"):
    os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/train")
if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/test"):
    os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/test")
for i in range(3):
    if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/train/" + str(i)):
        os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/train/"+str(i))
    if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/test/" + str(i)):
        os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/test/"+str(i))

for i in string.ascii_uppercase:
    if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/train/" + i):
        os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/train/"+i)
    if not os.path.exists("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/test/" + i):
        os.makedirs("C:/Users/Harshit Gupta/Sign-Language-to-Text-master/data/test/"+i)
